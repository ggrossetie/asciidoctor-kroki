...
// Path suffix -> real replacement file, resolved as a normal module (so its own
// relative imports, e.g. `./base64.js`, resolve normally too).
const PATH_REDIRECTS = new Map([
  ['/src/fetch.js', join(__dirname, 'src/fetch.browser.js')],
])
